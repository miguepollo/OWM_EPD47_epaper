...
#define number_of_dashes 20
  ...
  for (int i = 0; i < days_forecast; i++) {
    drawString(20 + x_pos + gwidth / 5 * i, y_pos + gheight + 10, String(i) + "d", LEFT);
    if (i < days_forecast - 1) drawFastVLine(x_pos + gwidth / days_forecast * i + gwidth / days_forecast, y_pos, gheight, LightGrey);
  }
}
